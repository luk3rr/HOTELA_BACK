...
/**
 * @details Converte a classe Cnpj (Value Object) para String (apenas números)
...
public class CnpjConverter implements AttributeConverter<Cnpj, String> {
    ...
    /**
     * @details Converte o Value Object Cnpj para uma String (apenas números)
     *          a ser armazenada no banco.
     * @param attribute O objeto Cnpj. Pode ser null.
     * @return A representação String do CNPJ (apenas números), ou null se o
     *         atributo for null.
     */
    @Override
     ...
     * @throws IllegalArgumentException se a string do banco não formar um CNPJ
     *                                  válido
     *                                  (a validação é feita no construtor de Cnpj).
     */
    @Override
