...
/**
 * @details Converte a classe Cpf (Value Object) para String (apenas números)
 *          para persistência no banco e vice-versa.
 */
@Converter
public class CpfConverter implements AttributeConverter<Cpf, String> {

    /**
     * @details Converte o Value Object Cpf para uma String (apenas números)
     *          a ser armazenada no banco.
     * @param attribute O objeto Cpf. Pode ser null.
     * @return A representação String do CPF (apenas números), ou null se o atributo
     *         for null.
     */
    @Override
    ...
    /**
     * @details Converte a String (apenas números) do banco de dados de volta para
     *          um objeto Cpf.
     ...
     * @throws IllegalArgumentException se a string do banco não formar um CPF
     *                                  válido
     *                                  (a validação é feita no construtor de Cpf).
     */
    @Override
