...
/**
 * @details Representa um número de telefone (Value Object).
 *          Valida um formato específico: código do país, DDD e número.
 *          É imutável.
 */
public final class Telephone {

    /**
     * @details Regex para validar o formato "codigo_pais<espaço>ddd<espaço>numero".
     *          Exemplos: "55 31 999999999", "1 415 1234567".
     ...
     * @throws IllegalArgumentException se o valor fornecido for em branco ou não
     *                                  corresponder ao formato de telefone
     *                                  esperado.
     */
    public Telephone(String value) {
        ...
        if (!TELEPHONE_PATTERN.matcher(trimmedValue).matches()) {
            throw new IllegalArgumentException(
                    "Invalid telephone format. Expected format like '55 31 999999999', but got: " + value);
        }
