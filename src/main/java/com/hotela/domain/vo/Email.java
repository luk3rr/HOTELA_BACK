...
/**
 * @details Representa um endereço de e-mail válido (Value Object).
 *          Garante que qualquer instância represente um email que passou por
...
public class Email {
     ...
     * @throws IllegalArgumentException se o valor fornecido for nulo, em branco ou
     *                                  não corresponder a um formato de e-mail
     *                                  válido.
     */
